// app/termos/page.tsx — Espaço Invisível — Terms and Conditions Page
...
export const metadata: Metadata = {
  title: "Termos e Condições | Espaço Invisível",
  description:
    "Leia os termos e condições de uso do Espaço Invisível. Ao acessar ou usar nosso serviço, você concorda com estes termos na íntegra.",
  keywords: [
    "termos e condições",
    "termos de uso",
    "condições de uso",
  ...
  alternates: {
    canonical: "https://espacoinvisivel.com.br/termos",
    languages: {
      "pt-BR": "https://espacoinvisivel.com.br/termos",
    },
  },
  openGraph: {
    title: "Termos e Condições | Espaço Invisível",
    description:
      "Termos e condições de uso do site Espaço Invisível. Leia antes de usar nosso serviço.",
    url: "https://espacoinvisivel.com.br/termos",
  ...
  return (
    <>
      ...
      <link
        rel="alternate"
        hrefLang="pt-BR"
        href="https://espacoinvisivel.com.br/termos"
      />
      ...
      <main id="main-content">
        ...
        <section className="hero" aria-labelledby="hero-h1">
          ...
          <div className="wrap hero__in">
            ...
            <p className="hero__lead">
              Estes Termos e Condições regem seu uso do nosso site. Ao acessar
              ou usar nosso serviço, você concorda com estes termos na íntegra.
            </p>
          </div>
        </section>

        {/* ═══════════════════════════════════════════════════════ ACEITAÇÃO DOS TERMOS */}
        <section id="aceitacao" className="sec" aria-labelledby="aceitacao-h2">
          <div className="wrap">
            <article className="prose">
              <h2 id="aceitacao-h2" className="sh2">
                Aceitação dos termos
              </h2>
              <ul className="slist">
                <li>
                  Ao utilizar o <Link href="/">Espaço Invísivel</Link>, você confirma que tem pelo
                  menos 18 anos de idade.
                </li>
                <li>
                  Se você não concordar com esses termos, não use nosso site.
                </li>
              </ul>
            </article>
          </div>
        ...
        {/* ═══════════════════════════════════════════════════════ USO DE NOSSO SERVIÇO */}
        <section id="uso" className="sec sec--tint" aria-labelledby="uso-h2">
          <div className="wrap">
            <article className="prose">
              <h2 id="uso-h2" className="sh2">
                Uso de nosso serviço
              </h2>

              <h3 className="sh3">O que você pode fazer:</h3>
              <ul className="slist">
                <li>Visualizar e baixar conteúdo para uso pessoal</li>
                <li>Imprimir páginas para referência pessoal</li>
              </ul>

              <h3 className="sh3">O que você não pode fazer:</h3>
              <ul className="slist slist--red">
                <li>Republicar nosso conteúdo sem permissão</li>
                <li>Usar nosso site para fins comerciais</li>
                <li>Vender ou redistribuir nossos materiais</li>
                <li>Criar scripts automatizados para coletar nossos dados</li>
                <li>Fazer upload de conteúdo nocivo ou vírus</li>
                <li>Usar nosso serviço para atividades ilegais</li>
              </ul>
            </article>
          </div>
        </section>
        ...
        {/* ═══════════════════════════════════════════════════════ CONTEÚDO DO USUÁRIO */}
        <section id="conteudo" className="sec" aria-labelledby="conteudo-h2">
          <div className="wrap">
            <article className="prose">
              <h2 id="conteudo-h2" className="sh2">
                Conteúdo do usuário
              </h2>
              <p>Se você enviar qualquer conteúdo para o nosso site:</p>
              <ul className="slist">
                <li>
                  Você nos concede uma licença mundial e não exclusiva para usar
                  esse conteúdo
                </li>
                <li>Você garante que o conteúdo é original e legal</li>
                <li>
                  Nós nos reservamos o direito de remover qualquer conteúdo sem
                  aviso prévio
                </li>
              </ul>
            </article>
        ...
        <section
          ...
          aria-labelledby="propriedade-h2"
        >
          <div className="wrap">
            <article className="prose">
              <h2 id="propriedade-h2" className="sh2">
                Propriedade intelectual
              </h2>
              <ul className="slist">
                <li>
                  Todo o conteúdo do Espaço Invisível é de nossa propriedade ou
                  de nossos licenciadores
                </li>
                <li>
                  Você não pode copiar, modificar ou redistribuir nossa
                  propriedade intelectual sem permissão explícita
                </li>
              </ul>
            </article>
          </div>
        ...
        {/* ═══════════════════════════════════════════════════════ ACESSO AO SITE */}
        <section id="acesso" className="sec" aria-labelledby="acesso-h2">
          <div className="wrap">
            <article className="prose">
              <h2 id="acesso-h2" className="sh2">
                Acesso ao site
              </h2>
              <ul className="slist">
                <li>
                  Reservamo-nos o direito de restringir ou encerrar o acesso ao
                  nosso site
                </li>
                <li>Sua conta e senha são de sua responsabilidade</li>
                <li>Podemos desativar contas a nosso critério</li>
              </ul>
            </article>
          </div>
        </section>

        {/* ═══════════════════════════════════════════════════════ ISENÇÃO E LIMITAÇÕES */}
        <section
          id="isencao"
          className="sec sec--tint"
          aria-labelledby="isencao-h2"
        >
          <div className="wrap">
            <article className="prose">
              <h2 id="isencao-h2" className="sh2">
                Isenção de responsabilidade e limitações
              </h2>

              <h3 className="sh3">Sem garantias</h3>
              <ul className="slist">
                <li>
                  Nosso site é fornecido {"\"no estado em que se encontra\""}, sem
                  garantias
                </li>
                <li>
                  Não prometemos disponibilidade contínua ou precisão absoluta
                </li>
                <li>Não se trata de aconselhamento profissional</li>
              </ul>

              <h3 className="sh3">Limitações de responsabilidade</h3>
              <p>Não nos responsabilizamos por:</p>
              <ul className="slist slist--red">
                <li>Perdas diretas ou indiretas</li>
                <li>Interrupções de negócios</li>
                <li>Corrupção de dados</li>
                <li>Quaisquer danos decorrentes do uso do site</li>
              </ul>
            </article>
          </div>
        </section>
        ...
        >
          <div className="wrap">
            <article className="prose">
              ...
              <ul className="slist">
                <li>Usar nosso site com responsabilidade</li>
                <li>Proteger as informações de sua conta</li>
                <li>Não fazer uso indevido de nossos serviços</li>
        ...
        <section
          id="alteracoes"
          className="sec sec--tint"
          aria-labelledby="alteracoes-h2"
        >
          <div className="wrap">
            <article className="prose">
              <h2 id="alteracoes-h2" className="sh2">
                Alterações nos termos e lei aplicável
              </h2>

              <h3 className="sh3">Alterações nos termos</h3>
              <ul className="slist">
                <li>Podemos atualizar estes termos periodicamente</li>
                <li>
                  O uso contínuo do site implica a aceitação dos novos termos
                </li>
              </ul>

              <h3 className="sh3">Lei aplicável</h3>
              <ul className="slist">
                <li>Estes termos são regidos pelas leis de Nevada, EUA</li>
                <li>Quaisquer disputas serão resolvidas nos tribunais de Nevada</li>
              </ul>
      ...
      <style precedence="default">{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sh3:first-of-type { margin-top: 0; }
