...
export const metadata: Metadata = {
  title: "Discussões | Blog Espaço Invisível",
  description: "Artigos sobre discussões e tópicos diversos.",
};
...
export default function DiscussoesPage() {
  const posts = getPostsByCategorySlug("discussoes");
      ...
      <main>
        <section className="hero hero--blog">
          <div className="wrap hero__in">
            <h1 className="hero__h1">Discussões</h1>
